    ...
    <div>
      ...
      <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold leading-tight text-gray-900 mt-10">Dashboard</h1>
        </div>
      </header>
      <main>
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div class="px-4 py-6 sm:px-0">
            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96">
              <input class="disabled:opacity-75 bg-red-200">
              <button class="md:dark:disabled:focus:hover:bg-gray-400">
                asd
              </button>
              <button class="bg-[#121212]">Share on Twitter</button>
            </div>
          </div>
          <!-- /End replace -->
        </div>
